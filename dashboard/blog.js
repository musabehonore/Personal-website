...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function hideComment(blogId, commentId) {
      fetch(`https://personal-web-backend-318j.onrender.com/api/blogs/${blogId}/comments/${commentId}`, {
        method: 'PATCH',
        headers: {
    ...
    document.getElementById('hideButton').addEventListener('click', function () {
      // const commentId = "65eed6259e768f2fabb7e57d";
      hideComment(blogId, commentId);
    });
  });
